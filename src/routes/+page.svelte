...
<svelte:head>
  ...
  <meta
    name="description"
    content="Enter your name and discover the predicted age using advanced AI algorithms."
  />
</svelte:head>
...
<div class="container">
  ...
  <p class="subtitle">
    ...
    <a href="https://agify.io" target="_blank" rel="noopener noreferrer"
      >Powered by Agify</a
    >
  </p>
  ...
  <div class="input-section">
    <div class="input-group">
      <label for="name-input" class="input-label"
        >Enter a name to predict age</label
      >
      <input
        id="name-input"
        class="name-input"
    ...
    <div class="results">
      ...
      {:else if data.age !== null}
        <div class="age-result">
          The predicted age for <strong>{data.name}</strong> is
          <strong>{data.age}</strong> years old.
        </div>
      {:else if data.name}
        <div class="age-result">
